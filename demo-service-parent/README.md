...
demo-service-parent     各业务微服务的父项目, 无数据库访问
demo-service-support    各业务微服务底层技术框架, 无数据库访问
...
例如：
```bash
GET 请求: http://localhost:9003/orm/product/deleteProduct?id=P00006
```
或者
```bash
POST 请求: http://localhost:9003/orm/product/saveProduct
