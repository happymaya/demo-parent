...
import cn.happymaya.support.utils.BeanUtils;
import cn.happymaya.support.xml.XmlBuildFactoryTemplate;
...
public abstract class BasicRepository<T extends Entity<S>, S extends Serializable> extends XmlBuildFactoryTemplate {
    ...
    public Class<T> getClazz() {
        if (clazz == null) {
            throw new RuntimeException("Please initialize the clazz in the constructor");
        }
        return clazz;
    }
